(function ( $ ){
	...
	*/
	...
	var defaultKey		= 'MuQBm4wfsTEiyZhNUjMSjUz1WDKkf4ZP8K4Y010srgWfvC5A', // Unique master Xively API key to be used as a default
		defaultFeeds	= [113984400], // Comma separated array of Xively Feed ID numbers
		applicationName	= 'Aquarium Monitor', // Replaces Xively logo in the header
		dataDuration	= '', // Default duration of data to be displayed // ref: https://xively.com/dev/docs/api/data/read/historical_data/
		dataInterval	= 0, // Default interval for data to be displayed (in seconds)
		dataColor		= '20a0a0', // CSS HEX value of color to represent data (omit leading #)
						...
						if(datastreamIds && datastreamIds != '' && datastreamIds.indexOf(datastream.id) >= 0) {
							xively.datastream.history(feedId, datastream.id, {duration: duration, interval: interval, limit: 1000}, function(datastreamData) {
								...
								if(datastreamData.datapoints) {
									...
									var min2 = parseFloat(datastream.min_value) - .25*(parseFloat(datastream.max_value) - parseFloat(datastream.min_value));
									var max2 = parseFloat(datastream.max_value) + .25*(parseFloat(datastream.max_value) - parseFloat(datastream.min_value));
